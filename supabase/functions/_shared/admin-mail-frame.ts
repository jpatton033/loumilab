/**
 * Loumilab branded email frame (server copy).
 * Mirrors src/lib/admin/mailFrame.ts — keep the two in sync.
 */
...
/** Very small allowlist sanitiser for editor HTML arriving from the admin UI. */
