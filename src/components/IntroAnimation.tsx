    ...
    >
      ...
      <div className="relative flex flex-col items-center gap-8 px-6">
        ...
        <div className="flex flex-col items-center gap-3 text-center">
          ...
          <span className="opacity-0 animate-intro-tagline-2 relative font-display text-3xl md:text-5xl font-semibold tracking-[-0.02em] inline-flex items-baseline">
            <span className="bg-clip-text text-transparent bg-[linear-gradient(110deg,#8a8a8a_0%,#ffffff_45%,#8a8a8a_100%)] bg-[length:200%_100%] animate-intro-shimmer text-4xl md:text-6xl">
              L
            </span>
